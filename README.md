...
```bash
git clone git://github.com/kornosky/personal-site.git # replace [kornosky] with your github username if you fork first.
cd personal-site
...
* [@notrueblood](https://github.com/notrueblood)[<sup>[1]</sup>](https://github.com/kornosky/personal-site/pull/218) and [@sjhsieh](https://github.com/sjhsieh)[<sup>[2]</sup>](https://github.com/kornosky/personal-site/issues/168) for keeping my ego in check.
